...
for file in sys.argv[1:]:
    ...
    for idx, line in enumerate(lines):
        ...
        if header_start < 0:
            ...
            if sline.startswith("/**********"):  # Test Game Engine header starts this way.
                header_start = idx
            else:
                header_end = 0  # There is no Test Game Engine header.
                break
        else:
            if not sline.startswith(("*", "/*")):  # Not in the Test Game Engine header anymore.
                header_end = idx + 1  # The guard should be two lines below the Test Game Engine header.
                break
