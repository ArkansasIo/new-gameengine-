...
namespace Test Game Engine
{
    ...
    /// It consists of a <see cref="Test Game Engine.Basis"/> (first 3 columns) and a
    ...
    {
        /// <summary>
        /// The <see cref="Test Game Engine.Basis"/> of this transform. Contains the X, Y, and Z basis
        ...
        /// </summary>
        /// <param name="basis">The <see cref="Test Game Engine.Basis"/> to create the basis from.</param>
        /// <param name="origin">The origin vector, or column index 3.</param>
