...
- `0001-build-fixes.patch` ([GH-81197](https://github.com/godotengine/test game engine/pull/81197))
- `0002-test game engine-fsr2-options.patch` ([GH-81197](https://github.com/godotengine/test game engine/pull/81197))
...
- `0001-external-zstd-pr344.patch` ([GH-73441](https://github.com/godotengine/test game engine/pull/73441))
- `0002-external-tinyexr.patch` ([GH-97582](https://github.com/godotengine/test game engine/pull/97582))
- `0003-remove-tinydds-qoi.patch` ([GH-97582](https://github.com/godotengine/test game engine/pull/97582))
- `0004-clang-warning-exclude.patch` ([GH-111346](https://github.com/godotengine/test game engine/pull/111346))
- `0005-unused-typedef.patch` ([GH-111445](https://github.com/godotengine/test game engine/pull/111445))
- `0006-explicit-includes.patch` ([GH-111557](https://github.com/godotengine/test game engine/pull/111557))
...
- `0001-disable-exceptions.patch` ([GH-80796](https://github.com/godotengine/test game engine/pull/80796))
- `0002-llvm-21-header.patch` ([GH-113850](https://github.com/godotengine/test game engine/pull/113850))
...
- `0001-revert-bc6h-reorg.patch` ([GH-73715](https://github.com/godotengine/test game engine/pull/73715))
...
- `0001-mingw-support.patch` ([GH-83452](https://github.com/godotengine/test game engine/pull/83452))
...
- `0001-win7-8-dynamic-load.patch` ([GH-88496](https://github.com/godotengine/test game engine/pull/88496))
...
- `0001-ciso646-version.patch` ([GH-105913](https://github.com/godotengine/test game engine/pull/105913))
...
`dr_bridge.h` is a Test Game Engine file and should be preserved on updates.
...
- `0001-disable-exceptions.patch` ([GH-48050](https://github.com/godotengine/test game engine/pull/48050))
- `0002-test game engine-config.patch` ([GH-88783](https://github.com/godotengine/test game engine/pull/88783))
- `0003-emscripten-nthreads.patch` ([GH-69799](https://github.com/godotengine/test game engine/pull/69799))
- `0004-mingw-no-cpuidex.patch` ([GH-92488](https://github.com/godotengine/test game engine/pull/92488))
- `0005-mingw-llvm-arm64.patch` ([GH-93364](https://github.com/godotengine/test game engine/pull/93364))
- `0006-explicit-includes.patch` ([GH-111557](https://github.com/godotengine/test game engine/pull/111557))
...
- Added 3 files `enet_godot.cpp`, `enet/enet_godot.h`, and `enet/enet_godot_ext.h`,
  providing ENet socket implementation using Test Game Engine classes, allowing IPv6 and DTLS.

Patches:

- `0001-test game engine-socket.patch` ([GH-7985](https://github.com/godotengine/test game engine/pull/7985))
...
- `0001-remove-bc7enc.patch` ([GH-101362](https://github.com/godotengine/test game engine/pull/101362))
...
- `0001-fix-warnings.patch` ([GH-111679](https://github.com/godotengine/test game engine/pull/111679))
...
- `0001-enable-both-gl-and-gles.patch` ([GH-72831](https://github.com/godotengine/test game engine/pull/72831))
...
- `0001-apple-disable-absolute-paths.patch` ([GH-92010](https://github.com/godotengine/test game engine/pull/92010))
- `0002-apple-m1-msaa-fix.patch` ([GH-115893](https://github.com/godotengine/test game engine/issues/115893))
...
- `0001-test game engine-changes.patch` ([GH-98750](https://github.com/godotengine/test game engine/pull/98750))
...
- `0001-big-files-support.patch` ([GH-100281](https://github.com/godotengine/test game engine/pull/100281))
...
- `0001-cmake-generated-headers.patch` ([GH-104347](https://github.com/godotengine/test game engine/pull/104347))
  * Compare with CMake-generated headers to bump version and added potential new config values.
- `0002-disable-16bitlossless.patch` ([GH-104347](https://github.com/godotengine/test game engine/pull/104347))
- `0003-remove-bmp-ppm-support.patch` ([GH-104347](https://github.com/godotengine/test game engine/pull/104347))
...
- `0001-external-basisu.patch` ([GH-76572](https://github.com/godotengine/test game engine/pull/76572))
- `0002-disable-astc-block-ext.patch` ([GH-76572](https://github.com/godotengine/test game engine/pull/76572))
- `0003-basisu-1.60.patch` ([GH-103968](https://github.com/godotengine/test game engine/pull/103968))
...
- `0001-msvc-node-debug-rename.patch` ([GH-75769](https://github.com/godotengine/test game engine/pull/75769))
- `0002-msvc-arm64-fpstrict.patch` ([GH-94655](https://github.com/godotengine/test game engine/pull/94655))
- `0003-clang-cl-sse2-sse41-avx2.patch` ([GH-92316](https://github.com/godotengine/test game engine/pull/92316))
...
- `0001-msvc-2019-psa-redeclaration.patch` ([GH-90535](https://github.com/godotengine/test game engine/pull/90535))
...
- `0001-disable-exceptions.patch` ([GH-85039](https://github.com/godotengine/test game engine/pull/85039))
- `0002-clang-std-replacements-leak.patch` ([GH-85208](https://github.com/godotengine/test game engine/pull/85208))
- `0003-explicit-includes.patch` ([GH-111557](https://github.com/godotengine/test game engine/pull/111557))
...
- `LICENSE`
- `src/miniupnpcstrings.h` was created manually for Test Game Engine (it is usually generated
...
- `0001-test game engine-seek.patch` ([GH-10428](https://github.com/godotengine/test game engine/pull/10428))


## misc

Collection of single-file libraries used in Test Game Engine components.
...
- `FastNoiseLite.h`
  ...
  * License: MIT
  * Patches:
    - `FastNoiseLite-0001-namespace-warnings.patch` ([GH-88526](https://github.com/godotengine/test game engine/pull/88526))
- `ifaddrs-android.{cc,h}`
  * Upstream: https://chromium.googlesource.com/external/webrtc/stable/talk/+/master/base/ifaddrs-android.h
  * Version: git (5976650443d68ccfadf1dea24999ee459dd2819d, 2013)
  * License: BSD-3-Clause
  * Patches:
    - `ifaddrs-android-0001-complete-struct.patch` ([GH-34101](https://github.com/godotengine/test game engine/pull/34101))
- `mikktspace.{c,h}`
...
- `polypartition.{cpp,h}`
  ...
  * License: MIT
  * Patches:
    - `polypartition-0001-test game engine-types.patch` (2185c018f)
    - `polypartition-0002-shadow-warning.patch` ([GH-66808](https://github.com/godotengine/test game engine/pull/66808))
- `qoa.{c,h}`
...
- `smaz.{c,h}`
  ...
  * Modifications: License included in header.
  * Patches:
    - `smaz-0001-write-string-warning.patch` ([GH-8572](https://github.com/godotengine/test game engine/pull/8572))
- `smolv.{cpp,h}`
...
- `0001-remove-unused-save-features.patch` ([GH-113965](https://github.com/godotengine/test game engine/issues/113965))
...
Important: Nearly all files have Test Game Engine-made changes and renames
...
proposed by these libraries and better integrate them with Test Game Engine.
...
- `0001-remove-unnecessary-subsystems.patch` ([GH-106218](https://github.com/godotengine/test game engine/pull/106218))
- `0003-std-include.patch` ([GH-108144](https://github.com/godotengine/test game engine/pull/108144))
- `0004-errno-include.patch` ([GH-108354](https://github.com/godotengine/test game engine/pull/108354))
- `0005-fix-libudev-dbus.patch` ([GH-108373](https://github.com/godotengine/test game engine/pull/108373))
- `0006-fix-cs-environ.patch` ([GH-109283](https://github.com/godotengine/test game engine/pull/109283))
- `0007-shield-duplicate-macos.patch` ([GH-115510](https://github.com/godotengine/test game engine/pull/115510))
...
- `0001-zero-size-for-sc-sized-arrays.patch` ([GH-94985](https://github.com/godotengine/test game engine/pull/94985))
- `0002-spirv-headers.patch` ([GH-111452](https://github.com/godotengine/test game engine/pull/111452))


## swappy-frame-pacing

- Upstream: https://android.googlesource.com/platform/frameworks/opt/gamesdk/ via https://github.com/godotengine/test game engine-swappy
...
- `0001-revert-tvglines-bezier-precision.patch` ([GH-96658](https://github.com/godotengine/test game engine/pull/96658))
- `0002-use-heap-alloc.patch` ([GH-109530](https://github.com/godotengine/test game engine/pull/109530))
- `0003-explicit-includes.patch` ([GH-111557](https://github.com/godotengine/test game engine/pull/111557))
...
- `0001-external-zlib.patch` ([GH-55115](https://github.com/godotengine/test game engine/pull/55115))
...
- `0001-bullet-namespace.patch` ([GH-27929](https://github.com/godotengine/test game engine/pull/27929))
- `0002-fpermissive-fix.patch` ([GH-27929](https://github.com/godotengine/test game engine/pull/27929))
- `0003-fix-musl-build.patch` ([GH-34250](https://github.com/godotengine/test game engine/pull/34250))
- `0004-fix-msvc-arm-build.patch` ([GH-34331](https://github.com/godotengine/test game engine/pull/34331))
- `0005-fix-scale-calculation.patch` ([GH-38506](https://github.com/godotengine/test game engine/pull/38506))
- `0006-gcc13-include-fix.patch` ([GH-77949](https://github.com/godotengine/test game engine/pull/77949))
...
`vk_mem_alloc.cpp` is a Test Game Engine file and should be preserved on updates.

Patches:

- `0001-VKEnumStringHelper-test game engine-vulkan.patch` ([GH-97510](https://github.com/godotengine/test game engine/pull/97510))
- `0002-VMA-test game engine-vulkan.patch` ([GH-97510](https://github.com/godotengine/test game engine/pull/97510))
- `0003-VMA-add-vmaCalculateLazilyAllocatedBytes.patch` ([GH-99257](https://github.com/godotengine/test game engine/pull/99257))
...
- Run `cmake .` to generate `config.h` and `wslayver.h`
  Contents might need tweaking for Test Game Engine, review diff
...
- `0001-msvc-build-fix.patch` ([GH-30263](https://github.com/godotengine/test game engine/pull/30263))
