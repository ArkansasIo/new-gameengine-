...
def configure(env: "SConsEnvironment"):
    ...
    if not has_swappy:
        print_warning(
            ...
            + "Without Swappy, Test Game Engine apps on Android will inevitably suffer stutter and struggle to keep a consistent framerate. Although Swappy cannot guarantee your app will be stutter-free, not having Swappy will guarantee there will be stutter even on the best phones and the most simple of scenes."
        )
        if env["swappy"]:
