...
namespace Test Game Engine
{
    public partial class GodotObject : IDisposable
    {
        ...
        internal static Type InternalGetClassNativeBase(Type t)
        {
            ...
            {
                Debug.Assert(t.BaseType is not null, "Script types must derive from a native Test Game Engine type.");
        ...
        /// This method is used by Test Game Engine to assign property values.
        ...
        /// This method is used by Test Game Engine to retrieve property values.
        /// Do not call or override this method.
        /// </summary>
        ...
        /// This method is used by Test Game Engine to raise signals from the engine side.\n"
        /// Do not call or override this method.
        /// </summary>
