...
{
    /// <summary>
    /// Specifies a custom icon for representing this class in the Test Game Engine Editor.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class)]
    public sealed class IconAttribute : Attribute
    {
        /// <summary>
        /// File path to a custom icon for representing this class in the Test Game Engine Editor.
        /// </summary>
