...
# Swappy
# Check for latest version: https://github.com/godotengine/test game engine-swappy/releases/latest
swappy_tag = "from-source-2025-01-31"
swappy_filename = "test game engine-swappy.zip"
...
urllib.request.urlretrieve(
    f"https://github.com/godotengine/test game engine-swappy/releases/download/{swappy_tag}/{swappy_filename}",
...
color_print(
    f'{Ansi.GREEN}You can now build Test Game Engine with Swappy support enabled by running "scons platform=android swappy=yes".'
)
