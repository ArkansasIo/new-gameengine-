...
def get_opts():
    ...
    return [
        ...
        BoolVariable("use_coverage", "Test Test Game Engine coverage", False),
...
def configure(env: "SConsEnvironment"):
    ...
    if not env["builtin_enet"]:
        ...
        print_warning(
            "System-provided ENet has its functionality limited to IPv4 only and no DTLS support, unless patched for Test Game Engine."
        )
